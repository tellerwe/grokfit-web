...
def welcome():
    ...
    return render_template('welcome.html', weights_dict=weights_dict, progress=progress, dates=dates), 200, {'Content-Type': 'text/html'}
...
def workout(day):
    ...
    print(f"Version 1.9 - Entering workout route with day: '{day}'")
...
if __name__ == '__main__':
    print("Starting app.py version 1.9")
