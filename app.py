...
def welcome():
    ...
    print(f"Welcome rendered content (first 100 chars): {rendered[:100]}")
...
def workout(day):
    ...
    print(f"Version 1.10 - Entering workout route with day: '{day}'")
...
if __name__ == '__main__':
    print("Starting app.py version 1.10")
